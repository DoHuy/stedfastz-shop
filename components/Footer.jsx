...
const Footer = () => {
    ...
    const TiktokIcon = () => (<svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"> <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3z"/> </svg>)
    const YoutubeIcon = () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"> <path d="M21.593 7.203a2.506 2.506 0 0 0-1.762-1.766C18.265 5.007 12 5 12 5s-6.264-.007-7.831.404a2.56 2.56 0 0 0-1.766 1.778c-.413 1.566-.417 4.814-.417 4.814s-.004 3.264.406 4.814c.23.857.905 1.534 1.763 1.765 1.582.43 7.83.437 7.83.437s6.265.007 7.831-.403a2.515 2.515 0 0 0 1.762-1.766c.407-1.566.41-4.814.41-4.814s.004-3.264-.406-4.814zM10 15.146V8.854L15.764 12 10 15.146z"/> </svg>)

const linkSections = [
    {
        title: "SẢN PHẨM",
        links: [
            // Nhóm Thẩm Mỹ & Trang Trí Xe Máy Điện
            { text: "Tem Xe & Decal Trang Trí", path: '/shop/decal-tem-xe', icon: null },
            { text: "Đồ Chơi Kiểng (Gương, Ốc Titan)", path: '/shop/do-choi-kieng', icon: null },
            
            // Nhóm Tiện Ích & Hiệu Năng
            { text: "Tiện Ích (Giá đỡ ĐT, Thảm lót)", path: '/shop/tien-ich', icon: null },
            { text: "Nâng Cấp Hiệu Năng (Phuộc, Đèn)", path: '/shop/hieu-nang', icon: null },
            
            // Nhóm Phụ Kiện Ô Tô Điện
            { text: "Nội Thất & Tiện Nghi Ô Tô", path: '/shop/noi-that-oto', icon: null },
            { text: "Công Nghệ & Android Box", path: '/shop/cong-nghe-oto', icon: null },
            
            // Nhóm Sạc & Bảo Vệ
            { text: "Phụ Kiện Sạc (Súng, Trụ sạc)", path: '/shop/phu-kien-sac', icon: null },
        ]
    },
    {
        title: "WEBSITE?", // Bạn có thể muốn đổi thành "PAGES" hoặc "NAVIGATION"
        links: [
            { text: "Trang chủ", path: '/', icon: null },
            { text: "Cửa hàng", path: '/shop', icon: null },
            { text: "Nâng cấp thành viên vip", path: '/nang-cap-vip', icon: null },
        ]
    },
    {
        title: "LIÊN HỆ",
        links: [
            // Lưu ý: Đảm bảo các Icon Component (MailIcon, PhoneIcon...) đã được import
            { text: "+84-xxx-xxx", path: 'tel:+84-xxx-xxx', icon: PhoneIcon }, // Đã sửa path thành tel:
            { text: "contact@stedfastz.com", path: 'mailto:contact@stedfastz.com', icon: MailIcon }, // Đã sửa path thành mailto:
            { text: "Hà Nội, Việt Nam", path: 'https://maps.google.com/?q=Hanoi', icon: MapPinIcon } // Đã sửa icon khớp với địa chỉ
        ]
    }
];
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">xe điện </span>chất<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Chào mừng bạn đến với Xe điện chất! – Địa chỉ tin cậy dành cho cộng đồng yêu xe xanh. Chúng tôi tự hào là thế giới phụ kiện dành cho xe điện, mang đến những giải pháp nâng cấp toàn diện từ thẩm mỹ đến hiệu năng cho xế yêu của bạn.</p>
