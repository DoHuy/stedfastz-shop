...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Thông số kỹ thuật của chúng tôi' description="Chúng tôi cung cấp dịch vụ và sự tiện lợi hàng đầu để đảm bảo trải nghiệm mua sắm của bạn được suôn sẻ, an toàn và hoàn toàn không rắc rối." />
